    ...
    return (
        <div className={styles.wrapperHero}>
            ...
            <div className={styles.wrapperHeroDescription}>
                ...
                <div className={styles.HeroProfile}><img src="/img/me-hero.webp" alt="hero" /></div>
                <div className={styles.HeroSkill}>
                    <div className={styles.HeroSkillImg}><img src="/img/skill-react.webp" alt="skill1" /><p>React JS Developer</p></div>
                    <div className={styles.HeroSkillImg}><img src="/img/skill-pwa.webp" alt="skill2" /><p>PWA</p></div>
                    <div className={styles.HeroSkillImg}><img src="/img/skill-js.webp" alt="skill3" /><p>Javascript</p></div>
                </div>
            </div>
        </div>
    )
